...
<div class="ComSearch-board">
	...
	<%
        ...
        System.out.println("ComCode: " + ComCode + ", Vendor Code : " + Vendor); // ComCode 값을 console에 출력
	...
	<%
        ...
        ResultSet rs = null;
        /* String sql = "SELECT * FROM matmaster,company WHERE Company = ? AND Com_Cd = ?"; */
	...
	%>
        <tr>
            <td colspan="4"><a href="javascript:void(0)" onClick="window.close();">Company Code에 해당하는 재료가 없습니다.</a></td>
        </tr>
	<%
        } else{
        	do{
