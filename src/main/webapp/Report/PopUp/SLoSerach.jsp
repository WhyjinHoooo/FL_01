		                ...
		                <tr>
		                    <td>
		                    	<a href="javascript:void(0)" onClick="
		                    		window.opener.document.querySelector('.SLocCode').value='<%=rs.getString("STORAGR_ID")%>';
		                    		window.opener.document.querySelector('.SLocCode').dispatchEvent(new Event('change'));
		                    		window.close();">
