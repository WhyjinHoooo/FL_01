...
<%
    ...
    try {
        String SlipCode = request.getParameter("SlipCode"); // 결재자 의견 작성한 전표
        String Opinion = request.getParameter("Opinion"); // 결재자의 의견
        ...
        System.out.println("ajax가 실행되는 확인하기 위해 전달받은 전표 : " + SlipCode);
        ...
        if(BeforeDate != null){
			...
			Update_Pstmt.setString(5, SlipCode);
