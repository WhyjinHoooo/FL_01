...
<hr>
	<center>
		<div class="ComSearch-board">
			...
			%>
			<tr>
			    <td><a href="javascript:void(0)" onClick="var BAGroup = '<%=rs.getString("BAGroup")%>';window.opener.document.querySelector('.BAG-code').value= BAGroup ;window.opener.document.querySelector('.BAG-code').dispatchEvent(new Event('change')); window.close();"><%=rs.getString("BAGroup") %></a></td>
